...
of your app from the deployment of your features. Launch darkly does not currently support scheduled flag deployments.

Enter ld-scheduler.

You can now create your flags in launch darkly and then set a date and time you want the kill switch to be turned on or off. This decouples your app deployment
...
1. You should create a new node project and import ld-scheduler and invoke the runEveryXSeconds function.
...
2. Tag your feature flag. In launch darkly's dashboard, under the Settings tab of your feature flag, under Tags, add a tag called "scheduled". Still in the 
Settings tab, under Description, add the following JSON object:
 ...
 * description is a textual description of the purpose of the flag for human readability
 ...
 This screenshot below is an example configuration:
