...
var _filterFlags = require('./filterFlags');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            outstandingTasks = (0, _filterFlags2.default)(scheduledFlags, slack);
          ...
          case 8:
            ...
            outstandingTasks.forEach(function () {
              var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee(task) {
                var taskType, key, value, path, message, body, url, response;
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      ...
                      case 10:
                        message = 'ERROR: Unknown task type: ' + taskType;
                        return _context.abrupt('return', (0, _sendSlackMessgae2.default)(message, slack));
