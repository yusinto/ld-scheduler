...
exports.default = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(_ref2, ldEnvironment, slackWebhook) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            message = '[' + (0, _upperFirst2.default)(ldEnvironment) + '] ';
          ...
          case 21:
            ...
            console.log('Network error. Could not reach Slack. Did not post to slack regarding ' + isUpdateSuccessful + ', ' + key + ': ' + value + '. ' + _context.t0);
