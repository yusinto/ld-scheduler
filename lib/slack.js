...
exports.default = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(_ref2, environment, slack) {
    ...
    var message, onOff, rolloutPercentages;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 13:
            return _context.abrupt('return', (0, _sendSlackMessgae2.default)(message, slack, 'Network error. Could not reach Slack. Did not post to slack regarding ' + isUpdateSuccessful + ', ' + key + ': ' + value + '.'));
